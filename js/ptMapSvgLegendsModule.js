...
Box.Application.addModule('ptMapSvgLegendsModule', function(context) {
	...
	var beforeInitialize = function(){
		scope.state = mapsConfig.mapConfig.state;
	    ...
	    dataHashMap = {
	        'default': {name: '', source: 'http://google.com'},
        ...
        scope.toggleSVgLegend = function(reset) {
